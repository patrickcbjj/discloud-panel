...
const DICTS = {
  pt: {
    ...
    settings: {
      ...
      updateAvailable: 'Nova versão {v} disponível.',
      updateDownloading: 'Baixando atualização {v}…',
      updateDownloaded: 'Versão {v} baixada — reinicie para aplicar.',
      restartAndInstall: 'Reiniciar e instalar',
      updateError: 'Falha ao verificar: {e}',
      updateChannelHint: 'Atualizações vêm das GitHub Releases. Em apps não empacotados (dev) o updater fica desativado.',
      autoCheckHint: 'O painel verifica automaticamente ao abrir e a cada 6h.',
      bytesOf: '{a} de {b}',
      speed: 'velocidade',
      about: 'Sobre',
      aboutTitle: 'Sobre o Discloud Panel',
      aboutTagline: 'Painel desktop não-oficial para apps hospedados na Discloud',
      aboutAuthor: 'Desenvolvido por',
      aboutLicense: 'Licença',
      aboutSourceCode: 'Código-fonte',
      aboutReportBug: 'Reportar um problema',
      aboutBuiltWith: 'Construído com',
      aboutClose: 'Fechar',
      aboutSystem: 'Sistema',
      aboutCopyDebug: 'Copiar info de debug',
      aboutCopied: 'Copiado!',
      aboutDisclaimer: 'Este painel não tem afiliação oficial com a Discloud. Usa apenas a API pública.',
      updateModalTitle: 'Nova versão disponível',
      updateModalSubtitle: 'A versão {v} do Discloud Panel está disponível para download.',
      updateModalCurrent: 'Você está na v{v}',
      updateModalDownload: 'Baixar agora',
      updateModalLater: 'Mais tarde',
      updateModalWhatsNew: 'O que há de novo',
      buildLogTitle: 'Build log',
      buildLogSubtitle: 'Saída do build da Discloud para este deploy',
      buildLogEmpty: 'Nenhum log de build foi capturado para este deploy.',
      buildLogCopy: 'Copiar',
      buildLogCopied: 'Copiado!',
      buildLogDownload: 'Salvar como .txt',
      buildLogClose: 'Fechar',
      buildLogSize: '{n} caracteres',
      buildLogView: 'Ver build log',
      buildLogTruncated: 'Log truncado (mantendo o final, que é o relevante pra debug).',
      slaTitle: 'Disponibilidade',
      slaSubtitle: '% de tempo que o app esteve online dentro da janela monitorada',
      slaLast24h: 'Últimas 24h',
      slaLast7d: 'Últimos 7 dias',
      slaLast30d: 'Últimos 30 dias',
      slaSamples: '{n} amostras',
      slaInsufficient: 'Dados insuficientes',
      slaCaveat: 'Calculado apenas sobre o tempo em que o painel estava aberto coletando.',
      healthScore: 'Saúde',
  ...
  en: {
    ...
    settings: {
      ...
      updateDownloading: 'Downloading update {v}…',
      updateDownloaded: 'Version {v} downloaded — restart to apply.',
      restartAndInstall: 'Restart and install',
      updateError: 'Check failed: {e}',
      updateChannelHint: 'Updates come from GitHub Releases. The updater is disabled in unpackaged (dev) builds.',
      autoCheckHint: 'The panel checks automatically on startup and every 6 hours.',
      bytesOf: '{a} of {b}',
      speed: 'speed',
      about: 'About',
      aboutTitle: 'About Discloud Panel',
      aboutTagline: 'Unofficial desktop panel for apps hosted on Discloud',
      aboutAuthor: 'Developed by',
      aboutLicense: 'License',
      aboutSourceCode: 'Source code',
      aboutReportBug: 'Report an issue',
      aboutBuiltWith: 'Built with',
      aboutClose: 'Close',
      aboutSystem: 'System',
      aboutCopyDebug: 'Copy debug info',
      aboutCopied: 'Copied!',
      aboutDisclaimer: 'This panel is not officially affiliated with Discloud. It only uses the public API.',
      updateModalTitle: 'New version available',
      updateModalSubtitle: 'Discloud Panel {v} is available for download.',
      updateModalCurrent: 'You are on v{v}',
      updateModalDownload: 'Download now',
      updateModalLater: 'Later',
      updateModalWhatsNew: "What's new",
      buildLogTitle: 'Build log',
      buildLogSubtitle: 'Discloud build output for this deploy',
      buildLogEmpty: 'No build log was captured for this deploy.',
      buildLogCopy: 'Copy',
      buildLogCopied: 'Copied!',
      buildLogDownload: 'Save as .txt',
      buildLogClose: 'Close',
      buildLogSize: '{n} characters',
      buildLogView: 'View build log',
      buildLogTruncated: 'Log truncated (kept the tail, which is what matters for debugging).',
      slaTitle: 'Availability',
      slaSubtitle: '% of time the app was online within the monitored window',
      slaLast24h: 'Last 24h',
      slaLast7d: 'Last 7 days',
      slaLast30d: 'Last 30 days',
      slaSamples: '{n} samples',
      slaInsufficient: 'Insufficient data',
      slaCaveat: 'Computed only over time when the panel was open collecting.',
      healthScore: 'Health',
